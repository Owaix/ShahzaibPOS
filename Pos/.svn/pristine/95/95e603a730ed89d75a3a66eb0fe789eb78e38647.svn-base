...
namespace SalesMngmt.Reporting
{
    public partial class ExpiredItems : MetroFramework.Forms.MetroForm
    {
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            var ExpireItems = db.GetExpiredItems(dtTo.Value, dtFrom.Value).ToList();
            var count = ExpireItems.Count();
            ...
            if (ExpireItems == null)
            {
                ...
                for (int b = 0; b < count; b++)
                {
                    ...
                    CategorysDataGridView.Rows.Add(a, ExpireItems[b].IName, ExpireItems[b].CTN, ExpireItems[b].PCS,(DateTime)ExpireItems[b].ExpDT);
                    a++;
