...
{
    public partial class LabList : MetroFramework.Forms.MetroForm
    {
        ...
        private void CategorysDataGridView_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            var detail = db.Lab_D.AsNoTracking().Where(x => x.RID == abc);
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            var Record = db.LabList(dtTo.Value, dtFrom.Value);
