namespace SalesMngmt.Configs
{
    partial class ArticleType
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.txtcat.DataBindings.Add(new System.Windows.Forms.Binding("Text", this.articleTypeBindingSource, "ArticleTypeName", true));
            ...
            this.CategorysDataGridView.DataSource = this.articleTypeBindingSource;
