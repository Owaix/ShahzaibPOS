...
{
    public partial class VendorLedger : MetroFramework.Forms.MetroForm
    {
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            var previosBalance = db.getVendorPreviousBalance(dtTo.Value, Vendorcode).FirstOrDefault();
            int a = 1;
            ...
            var getdata = db.getVendorLedgerBYDate(dtTo.Value, dtFrom.Value,Vendorcode ).ToList();//db.getVendorLedgerBYDate(dtTo.Value, dtFrom.Value,;
