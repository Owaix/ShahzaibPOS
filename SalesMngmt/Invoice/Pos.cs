...
namespace SalesMngmt.Invoice
{
    public partial class Pos : MetroFramework.Forms.MetroForm
    {
        ...
        private void Pos_Load(object sender, EventArgs e)
        {
            ...
            label33.Text = CompaniesModel.CompanyTitle;
        }
        ...
        {
            var categoryList = db.Items_Cat.Where(x => x.CompanyID == UserObj.AccessFailedCount).ToList();
            int locY = 9; // 73
        ...
        protected void MetroTile_Clickitem(object sender, EventArgs e)
        {
            ...
            if (DineIn == true && lblTblID.Text == "0")
            {
                ...
                {
                    TablsList table = new TablsList(0, "new", lblTblID.Text, UsrID, this, UserObj);
                    this.Hide();
                    table.Show();
                    return;
                }
        ...
        private void savePrint(string type)
        {
            ...
            using (var transaction = db.Database.BeginTransaction())
            {
                try
                {
                    ...
                    order.userID = Convert.ToInt16(UsrID);
        ...
        private void LedgerEntires(tbl_OrderDetails details)
        {
            ...
            if (checkstock.Inv_YN == false)
            {
                ...
                cmd.Parameters.AddWithValue("@TypeCode", 23);
                ...
                //cmdGL.Parameters.AddWithValue("@GLDate", DateTime.Now);
        ...
        {
            TablsList table = new TablsList(0, "change", lblTblID.Text, UsrID, this, UserObj);
            this.Hide();
            table.Show();
        }
        ...
        public void SilentPrint(int OrderId, bool type)
        {
            try
            {
                ...
                foreach (var item in list)
                {
                    ...
                    orders.Qty = item.Qty;
                    orders.Rate = item.Rate - item.disc;
        ...
        {
            DeleteOrders inv = new DeleteOrders();
            inv.Show();
        }
